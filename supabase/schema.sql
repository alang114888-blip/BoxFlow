...
CREATE POLICY "Trainers can view their clients profiles" ON profiles
  FOR SELECT USING (
    EXISTS (
      ...
      WHERE p.role = 'trainer' AND tc.trainer_id = auth.uid() AND tc.client_id = profiles.id
    )
  );
...
-- ============================================
-- WORKOUT EXERCISES (within a day)
-- ============================================
...
-- ============================================
-- WORKOUT RESULTS (per exercise in a log)
-- ============================================
...
-- ============================================
-- FUTURE-PROOF TABLES (create now, use later)
-- ============================================
